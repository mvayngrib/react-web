...
var RouteStack = function () {
  function RouteStack(index, routeNodes) {
    ...
    (0, _invariant2.default)(routeNodes.size > 0, 'size must not be empty');

    (0, _invariant2.default)(index > -1 && index <= routeNodes.size - 1, 'index out of bound');
  ...
  _createClass(RouteStack, [{
    ...
    value: function push(route) {
      ...
      (0, _invariant2.default)(!isRouteEmpty(route), 'Must supply route to push');
    ...
    value: function jumpToIndex(index) {
      (0, _invariant2.default)(index > -1 && index < this._routeNodes.size, 'index out of bound');
    ...
    value: function replaceAtIndex(index, route) {
      (0, _invariant2.default)(!isRouteEmpty(route), 'Must supply route to replace');
...
var NavigationRouteStack = function (_RouteStack) {
  ...
  function NavigationRouteStack(index, routeNodes) {
    ...
    return _possibleConstructorReturn(this, (NavigationRouteStack.__proto__ || Object.getPrototypeOf(NavigationRouteStack)).call(this, index, new _immutable.List(nodes)));
  }
